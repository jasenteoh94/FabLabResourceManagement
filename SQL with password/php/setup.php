<?php 
if($_POST['db_server']&&$_POST['db_username']&&$_POST['db_password']&&$_POST['db_name']&&$_POST['root_id']&&$_POST['root_name']&&$_POST['root_password']&&$_POST['root_contact']&&$_POST['root_email']) 
